###版本`3.4.4`：`Release date:2015/12/31`
更新记录：

* 1、新增安装 MySQL 版本 5.7.10；
* 2、新增安装 MariaDB 版本 10.1.10；
* 3、不再编译安装 MySQL 或 MariaDB ，而是使用官方网站的 Repository 来 Yum 安装，以大量节约安装时间。
...
* 1、升级 OCI8 到版本 2.0.10（安装包提取自php-5.6.16）；
...
###版本`3.2.8`：`Release date:2015/08/15`
更新记录：
...
###版本`3.0.9`：`Release date:2015/04/20`
更新记录：
